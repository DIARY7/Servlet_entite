...
public class ServiceServlet extends HttpServlet {
    ...
    private void read(HttpServletRequest req, HttpServletResponse res) throws Exception {
        Vector v = Service.getAll();
        req.setAttribute("service", v);
        RequestDispatcher dispat = req.getRequestDispatcher("page/service.jsp");
    ...
    private void insert(HttpServletRequest req, HttpServletResponse res) throws Exception {
        Service.insert(req.getParameter("nom"));
        res.sendRedirect("ServiceServlet?action=read");
    }
    private void update(HttpServletRequest req, HttpServletResponse res) throws Exception {
        Service.update(req.getParameter("id"), req.getParameter("nom"));
        res.sendRedirect("ServiceServlet?action=read");
