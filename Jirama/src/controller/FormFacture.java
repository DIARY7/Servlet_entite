...
@WebServlet(name = "form-facture", urlPatterns = {"/form-facture"})
public class FormFacture extends HttpServlet {
    ...
    private void prepareForInsert(HttpServletRequest req, HttpServletResponse res) throws Exception {
        Vector service = Service.getAll();
        Vector client = Client.getAll();
        req.setAttribute("client", client);
        req.setAttribute("service", service);        
        RequestDispatcher dispat = req.getRequestDispatcher("form/form-facture.jsp");
        dispat.forward(req,res);
    }
    private void prepareForUpdate(HttpServletRequest req, HttpServletResponse res) throws Exception {
        Facture facture = Facture.getById(req.getParameter("id"));
